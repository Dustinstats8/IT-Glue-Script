...
def config_api_call():
    ...
    response = requests.get(
        'https://api.itglue.com/organizations/{0}/relationships/configurations?page[size]=1000'
    ...
    # Selenium browser window where they will be moved to the IT security group one by one due to the lack of bulk    #
    # moves
    ###################################################################################################################
...
def configurations():
    ...
    driver.implicitly_wait(10)
    driver.find_element_by_xpath('//*[@id="react-main"]/div/div[3]/nav/ul/li[4]/a/div').click()
    driver.implicitly_wait(10)
    ...
    print('\nNumber of Configurations:', len(url_list), '\n')
    ...
    ###################################################################################################################
    # Unfortunately IT Glue has a maximum of 1000 pages (i.e. configurations being pulled)                            #
    # This means that since there's greater than 1000 configurations, it's necessary to update in waves               #
    ###################################################################################################################
